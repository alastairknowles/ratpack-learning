...
public class QFlywaySchemaHistory extends com.querydsl.sql.RelationalPathBase<QFlywaySchemaHistory> {
    ...
    private static final long serialVersionUID = -506101659;
    ...
    public final com.querydsl.sql.PrimaryKey<QFlywaySchemaHistory> primary = createPrimaryKey(installedRank);

    public QFlywaySchemaHistory(String variable) {
        super(QFlywaySchemaHistory.class, forVariable(variable), "null", "flyway_schema_history");
        addMetadata();
    }
    ...
    public QFlywaySchemaHistory(Path<? extends QFlywaySchemaHistory> path) {
        super(path.getType(), path.getMetadata(), "null", "flyway_schema_history");
        addMetadata();
    }

    public QFlywaySchemaHistory(PathMetadata metadata) {
        super(QFlywaySchemaHistory.class, metadata, "null", "flyway_schema_history");
        addMetadata();
    }
